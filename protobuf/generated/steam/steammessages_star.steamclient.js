...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CSTAR_GlyphQueryParams = (function() {
        ...
        CSTAR_GlyphQueryParams.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.bundle_id != null && Object.hasOwnProperty.call(message, "bundle_id"))
    ...
    $root.CSTAR_ReadGlyphData_Request = (function() {
        ...
        CSTAR_ReadGlyphData_Request.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.query_params != null && Object.hasOwnProperty.call(message, "query_params"))
                $root.CSTAR_GlyphQueryParams.encode(message.query_params, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.last_modified_time_lower_limit != null && Object.hasOwnProperty.call(message, "last_modified_time_lower_limit"))
    ...
    $root.CSTAR_GlyphData = (function() {
        ...
        CSTAR_GlyphData.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.glyph_guid != null && Object.hasOwnProperty.call(message, "glyph_guid"))
                writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.glyph_guid);
            if (message.glyph_last_modified != null && Object.hasOwnProperty.call(message, "glyph_last_modified"))
                writer.uint32(/* id 2, wireType 2 =*/18).string(message.glyph_last_modified);
            if (message.glyph_json_data != null && Object.hasOwnProperty.call(message, "glyph_json_data"))
    ...
    $root.CSTAR_Request = (function() {
        ...
        CSTAR_Request.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.read_glyph_data != null && Object.hasOwnProperty.call(message, "read_glyph_data"))
                $root.CSTAR_ReadGlyphData_Request.encode(message.read_glyph_data, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.write_glyph_data != null && Object.hasOwnProperty.call(message, "write_glyph_data"))
