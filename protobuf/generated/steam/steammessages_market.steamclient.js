...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CEconMarket_IsMarketplaceAllowed_Response = (function() {
        ...
        CEconMarket_IsMarketplaceAllowed_Response.encode = function encode(message, writer) {
            ...
            if (message.allowed_at_time != null && Object.hasOwnProperty.call(message, "allowed_at_time"))
                writer.uint32(/* id 3, wireType 0 =*/24).uint32(message.allowed_at_time);
            if (message.steamguard_required_days != null && Object.hasOwnProperty.call(message, "steamguard_required_days"))
                writer.uint32(/* id 4, wireType 0 =*/32).uint32(message.steamguard_required_days);
            if (message.forms_requested != null && Object.hasOwnProperty.call(message, "forms_requested"))
                writer.uint32(/* id 7, wireType 0 =*/56).bool(message.forms_requested);
            if (message.forms_require_verification != null && Object.hasOwnProperty.call(message, "forms_require_verification"))
                writer.uint32(/* id 8, wireType 0 =*/64).bool(message.forms_require_verification);
            if (message.new_device_cooldown_days != null && Object.hasOwnProperty.call(message, "new_device_cooldown_days"))
