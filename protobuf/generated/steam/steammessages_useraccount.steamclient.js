...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CUserAccount_GetAvailableValveDiscountPromotions_Response = (function() {
        ...
        CUserAccount_GetAvailableValveDiscountPromotions_Response.ValveDiscountPromotionDetails = (function() {
            ...
            ValveDiscountPromotionDetails.encode = function encode(message, writer) {
                ...
                if (message.promotion_description != null && Object.hasOwnProperty.call(message, "promotion_description"))
                    writer.uint32(/* id 2, wireType 2 =*/18).string(message.promotion_description);
                if (message.minimum_cart_amount != null && Object.hasOwnProperty.call(message, "minimum_cart_amount"))
                    writer.uint32(/* id 3, wireType 0 =*/24).int64(message.minimum_cart_amount);
                if (message.minimum_cart_amount_for_display != null && Object.hasOwnProperty.call(message, "minimum_cart_amount_for_display"))
                    writer.uint32(/* id 4, wireType 0 =*/32).int64(message.minimum_cart_amount_for_display);
                if (message.discount_amount != null && Object.hasOwnProperty.call(message, "discount_amount"))
                ...
                if (message.available_use_count != null && Object.hasOwnProperty.call(message, "available_use_count"))
                    writer.uint32(/* id 7, wireType 0 =*/56).int32(message.available_use_count);
                if (message.promotional_discount_type != null && Object.hasOwnProperty.call(message, "promotional_discount_type"))
                    writer.uint32(/* id 8, wireType 0 =*/64).int32(message.promotional_discount_type);
                if (message.loyalty_reward_id != null && Object.hasOwnProperty.call(message, "loyalty_reward_id"))
                    writer.uint32(/* id 9, wireType 0 =*/72).int32(message.loyalty_reward_id);
                if (message.localized_name_token != null && Object.hasOwnProperty.call(message, "localized_name_token"))
                    writer.uint32(/* id 10, wireType 2 =*/82).string(message.localized_name_token);
                if (message.max_use_count != null && Object.hasOwnProperty.call(message, "max_use_count"))
    ...
    $root.CUserAccount_GetAccountLinkStatus_Response = (function() {
        ...
        CUserAccount_GetAccountLinkStatus_Response.encode = function encode(message, writer) {
            ...
            if (message.identity_verification != null && Object.hasOwnProperty.call(message, "identity_verification"))
                writer.uint32(/* id 2, wireType 0 =*/16).uint32(message.identity_verification);
            if (message.performed_age_verification != null && Object.hasOwnProperty.call(message, "performed_age_verification"))
    ...
    $root.CUserAccount_CreateFriendInviteToken_Request = (function() {
        ...
        CUserAccount_CreateFriendInviteToken_Request.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.invite_limit != null && Object.hasOwnProperty.call(message, "invite_limit"))
                writer.uint32(/* id 1, wireType 0 =*/8).uint32(message.invite_limit);
            if (message.invite_duration != null && Object.hasOwnProperty.call(message, "invite_duration"))
                writer.uint32(/* id 2, wireType 0 =*/16).uint32(message.invite_duration);
            if (message.invite_note != null && Object.hasOwnProperty.call(message, "invite_note"))
    ...
    $root.CUserAccount_CreateFriendInviteToken_Response = (function() {
        ...
        CUserAccount_CreateFriendInviteToken_Response.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.invite_token != null && Object.hasOwnProperty.call(message, "invite_token"))
    ...
    $root.CUserAccount_RegisterCompatTool_Request = (function() {
        ...
        CUserAccount_RegisterCompatTool_Request.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.compat_tool != null && Object.hasOwnProperty.call(message, "compat_tool"))
    ...
    $root.CAccountLinking_GetLinkedAccountInfo_Request = (function() {
        ...
        CAccountLinking_GetLinkedAccountInfo_Request.encode = function encode(message, writer) {
            ...
            if (message.return_access_token != null && Object.hasOwnProperty.call(message, "return_access_token"))
    ...
    $root.CAccountLinking_GetLinkedAccountInfo_Response = (function() {
        ...
        CAccountLinking_GetLinkedAccountInfo_Response.CExternalAccountTuple_Response = (function() {
            ...
            CExternalAccountTuple_Response.encode = function encode(message, writer) {
                ...
                if (message.external_user_name != null && Object.hasOwnProperty.call(message, "external_user_name"))
                    writer.uint32(/* id 3, wireType 2 =*/26).string(message.external_user_name);
                if (message.external_url != null && Object.hasOwnProperty.call(message, "external_url"))
                ...
                if (message.access_token_secret != null && Object.hasOwnProperty.call(message, "access_token_secret"))
    ...
    $root.CEmbeddedClient_AuthorizeCurrentDevice_Request = (function() {
        ...
        CEmbeddedClient_AuthorizeCurrentDevice_Request.encode = function encode(message, writer) {
            ...
            if (message.device_info != null && Object.hasOwnProperty.call(message, "device_info"))
    ...
    $root.CEmbeddedClient_Token = (function() {
        ...
        CEmbeddedClient_Token.encode = function encode(message, writer) {
            ...
            if (message.steamid != null && Object.hasOwnProperty.call(message, "steamid"))
                writer.uint32(/* id 1, wireType 1 =*/9).fixed64(message.steamid);
            if (message.client_token != null && Object.hasOwnProperty.call(message, "client_token"))
