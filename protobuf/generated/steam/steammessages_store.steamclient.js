...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CStore_GetLocalizedNameForTags_Response = (function() {
        ...
        CStore_GetLocalizedNameForTags_Response.Tag = (function() {
            ...
            Tag.encode = function encode(message, writer) {
                ...
                if (message.tagid != null && Object.hasOwnProperty.call(message, "tagid"))
                    writer.uint32(/* id 1, wireType 0 =*/8).uint32(message.tagid);
                if (message.english_name != null && Object.hasOwnProperty.call(message, "english_name"))
    ...
    $root.CStore_UserPreferences = (function() {
        ...
        CStore_UserPreferences.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.primary_language != null && Object.hasOwnProperty.call(message, "primary_language"))
                writer.uint32(/* id 1, wireType 0 =*/8).uint32(message.primary_language);
            if (message.secondary_languages != null && Object.hasOwnProperty.call(message, "secondary_languages"))
            ...
            if (message.hide_store_broadcast != null && Object.hasOwnProperty.call(message, "hide_store_broadcast"))
                writer.uint32(/* id 9, wireType 0 =*/72).bool(message.hide_store_broadcast);
            if (message.review_score_preference != null && Object.hasOwnProperty.call(message, "review_score_preference"))
                writer.uint32(/* id 10, wireType 0 =*/80).int32(message.review_score_preference);
            if (message.timestamp_content_descriptor_preferences_updated != null && Object.hasOwnProperty.call(message, "timestamp_content_descriptor_preferences_updated"))
    ...
    $root.CStore_GetStorePreferences_Response = (function() {
        ...
        CStore_GetStorePreferences_Response.encode = function encode(message, writer) {
            ...
            if (message.tag_preferences != null && Object.hasOwnProperty.call(message, "tag_preferences"))
                $root.CStore_UserTagPreferences.encode(message.tag_preferences, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.content_descriptor_preferences != null && Object.hasOwnProperty.call(message, "content_descriptor_preferences"))
