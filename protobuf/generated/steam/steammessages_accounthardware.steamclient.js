...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CAccountHardware_RegisterSteamController_Request = (function() {
        ...
        CAccountHardware_RegisterSteamController_Request.encode = function encode(message, writer) {
            ...
            if (message.controller_code != null && Object.hasOwnProperty.call(message, "controller_code"))
    ...
    $root.CAccountHardware_QueryAccountsRegisteredToSerial_Accounts = (function() {
        ...
        CAccountHardware_QueryAccountsRegisteredToSerial_Accounts.encode = function encode(message, writer) {
            ...
            if (message.registration_complete != null && Object.hasOwnProperty.call(message, "registration_complete"))
    ...
    $root.CAccountHardware_SteamControllerSetConfig_ControllerConfig = (function() {
        ...
        CAccountHardware_SteamControllerSetConfig_ControllerConfig.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.appidorname != null && Object.hasOwnProperty.call(message, "appidorname"))
    ...
    $root.CAccountHardware_SteamControllerSetConfig_Request = (function() {
        ...
        CAccountHardware_SteamControllerSetConfig_Request.encode = function encode(message, writer) {
            ...
            if (message.controller_type != null && Object.hasOwnProperty.call(message, "controller_type"))
                writer.uint32(/* id 5, wireType 0 =*/40).int32(message.controller_type);
            if (message.only_for_this_serial != null && Object.hasOwnProperty.call(message, "only_for_this_serial"))
    ...
    $root.CAccountHardware_VRCompatibilityCheck_Request = (function() {
        ...
        CAccountHardware_VRCompatibilityCheck_Request.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.product_name != null && Object.hasOwnProperty.call(message, "product_name"))
    ...
    $root.CAccountHardware_RegisterValveIndexComponent_Request = (function() {
        ...
        CAccountHardware_RegisterValveIndexComponent_Request.encode = function encode(message, writer) {
            ...
            if (message.serial_number != null && Object.hasOwnProperty.call(message, "serial_number"))
                writer.uint32(/* id 1, wireType 2 =*/10).string(message.serial_number);
            if (message.manufacturer_serial_number != null && Object.hasOwnProperty.call(message, "manufacturer_serial_number"))
                writer.uint32(/* id 2, wireType 2 =*/18).string(message.manufacturer_serial_number);
            if (message.component_code != null && Object.hasOwnProperty.call(message, "component_code"))
                writer.uint32(/* id 3, wireType 2 =*/26).string(message.component_code);
            if (message.component_type != null && Object.hasOwnProperty.call(message, "component_type"))
                writer.uint32(/* id 4, wireType 0 =*/32).int32(message.component_type);
            if (message.estimated_time_registered != null && Object.hasOwnProperty.call(message, "estimated_time_registered"))
