...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CMsgClientSiteInfo = (function() {
        ...
        CMsgClientSiteInfo.encode = function encode(message, writer) {
            ...
            if (message.allow_cached_credentials != null && Object.hasOwnProperty.call(message, "allow_cached_credentials"))
    ...
    $root.CMsgClientSiteLicenseGetContentCacheInfoResponse = (function() {
        ...
        CMsgClientSiteLicenseGetContentCacheInfoResponse.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.use_cache != null && Object.hasOwnProperty.call(message, "use_cache"))
            ...
            if (message.port_number != null && Object.hasOwnProperty.call(message, "port_number"))
                writer.uint32(/* id 3, wireType 0 =*/24).uint32(message.port_number);
            if (message.p2p_group != null && Object.hasOwnProperty.call(message, "p2p_group"))
