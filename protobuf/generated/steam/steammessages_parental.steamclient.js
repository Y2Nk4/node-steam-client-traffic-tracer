...
(function(global, factory) { /* global define, require, module */
    ...
    $root.ParentalApp = (function() {
        ...
        ParentalApp.encode = function encode(message, writer) {
            ...
            if (message.is_allowed != null && Object.hasOwnProperty.call(message, "is_allowed"))
    ...
    $root.ParentalSettings = (function() {
        ...
        ParentalSettings.encode = function encode(message, writer) {
            ...
            if (message.applist_base_id != null && Object.hasOwnProperty.call(message, "applist_base_id"))
                writer.uint32(/* id 2, wireType 0 =*/16).uint32(message.applist_base_id);
            if (message.applist_base_description != null && Object.hasOwnProperty.call(message, "applist_base_description"))
            ...
            if (message.passwordhashtype != null && Object.hasOwnProperty.call(message, "passwordhashtype"))
            ...
            if (message.enabled_features != null && Object.hasOwnProperty.call(message, "enabled_features"))
                writer.uint32(/* id 10, wireType 0 =*/80).uint32(message.enabled_features);
            if (message.recovery_email != null && Object.hasOwnProperty.call(message, "recovery_email"))
                writer.uint32(/* id 11, wireType 2 =*/90).string(message.recovery_email);
            if (message.is_site_license_lock != null && Object.hasOwnProperty.call(message, "is_site_license_lock"))
    ...
    $root.CParental_EnableParentalSettings_Request = (function() {
        ...
        CParental_EnableParentalSettings_Request.encode = function encode(message, writer) {
            ...
            if (message.enablecode != null && Object.hasOwnProperty.call(message, "enablecode"))
    ...
    $root.CParental_GetSignedParentalSettings_Response = (function() {
        ...
        CParental_GetSignedParentalSettings_Response.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.serialized_settings != null && Object.hasOwnProperty.call(message, "serialized_settings"))
    ...
    $root.CParental_ValidateToken_Request = (function() {
        ...
        CParental_ValidateToken_Request.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.unlock_token != null && Object.hasOwnProperty.call(message, "unlock_token"))
    ...
    $root.CParental_ValidatePassword_Request = (function() {
        ...
        CParental_ValidatePassword_Request.encode = function encode(message, writer) {
            ...
            if (message.send_unlock_on_success != null && Object.hasOwnProperty.call(message, "send_unlock_on_success"))
    ...
    $root.CParental_DisableWithRecoveryCode_Request = (function() {
        ...
        CParental_DisableWithRecoveryCode_Request.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.recovery_code != null && Object.hasOwnProperty.call(message, "recovery_code"))
